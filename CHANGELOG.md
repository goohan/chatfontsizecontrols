...
- Update the animated demonstration shown on the Marketplace profile.

## 0.0.6

- Add an animated demonstration of the chat zoom controls to the Marketplace profile.
...
- Keep Markdown and code block font sizes synchronized with a configurable offset.
- Add configurable step, limits, reset value, and keyboard shortcuts.
